...
const pujaSchedule = [
  {
    ...
    titleBn: "মহা ষষ্ঠী",
    events: [
      { time: "7:30 AM", name: "Bodhon & Amantran", icon: FiStar },
      { time: "5:30 PM", name: "Adhivas", icon: FiStar },
      { time: "7:30 PM", name: "Sandhya Aarti", icon: FiStar },
    ],
    highlight: "Bodhon & Devi's Awakening",
  },
  {
    day: "Day 2",
    date: "October 17",
    ...
    titleBn: "মহা সপ্তমী",
    events: [
      { time: "5:30 AM", name: "Nabapatrika Snan", icon: FiStar },
      { time: "8:30 AM", name: "Saptami Puja", icon: FiStar },
      { time: "6:30 PM", name: "Cultural Program", icon: FiMusic },
    ],
    highlight: "Kola Bou Snan",
  },
  {
    day: "Day 3",
    date: "October 18",
    ...
    titleBn: "মহা অষ্টমী",
    events: [
      { time: "7:00 AM", name: "Pushpanjali", icon: FiStar },
      { time: "11:30 AM", name: "Kumari Puja", icon: FiStar },
      { time: "8:00 PM", name: "Dhunuchi Naach", icon: FiMusic },
    ],
    highlight: "Anjali & Sandhi Puja (Evening)",
  },
  {
    day: "Day 4",
    date: "October 19",
    ...
    titleBn: "মহা নবমী",
    events: [
      { time: "8:00 AM", name: "Nabami Puja", icon: FiStar },
      { time: "1:30 PM", name: "Bhog Distribution", icon: FiStar },
      { time: "8:30 PM", name: "Sandhi Puja Rituals", icon: FiStar },
    ],
    highlight: "Maha Aarti & Homa",
  },
  {
    day: "Day 5",
    date: "October 20",
    ...
    titleBn: "বিজয়া দশমী",
    events: [
      { time: "9:00 AM", name: "Dashami Puja", icon: FiStar },
      { time: "11:30 AM", name: "Sindoor Khela", icon: FiStar },
      { time: "5:00 PM", name: "Bisarjan Procession", icon: FiStar },
    ],
    highlight: "Sindoor Khela & Farewell",
  },
];
        ...
        >
          <div>
            ...
            <p className="mt-3 max-w-xl text-pretty text-muted-foreground">
              Experience the 2026 festivities at Konarpara. Five days of profound devotion, 
              vibrant rituals, and shared community heritage.
            </p>
          </div>
          <Link
            href="/events"
                ...
                <div className="flex-1 p-4 lg:p-6">
                  ...
                  <div className="mt-4 flex items-center gap-2">
                    ...
                    <span className="text-xs font-medium text-accent italic">
                      Special Highlight: {day.highlight}
                    </span>
                  </div>
                </div>
              </div>
